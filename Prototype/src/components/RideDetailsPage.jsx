    ...
    return (
            ...
            <Box sx={{ padding: 3, flex: 1 }}>
                ...
                <Divider sx={{ marginBottom: 2 }} />
                    ...
                    <Box elevation={3} sx={{ padding: 3 , background: "powderblue", textAlign: 'left', ml:58,mr:58, boxShadow: 2, borderRadius: 3, '& .MuiTypography-root': {
                        marginBottom: 1.5,  // Apply bottom margin to all Typography elements
                        fontSize: '1.5rem', // Change font size for all Typography elements
                        color: 'black',
                        fontFamily: 'Lato'      // Set text color for all Typography elements
                    } }}> 
